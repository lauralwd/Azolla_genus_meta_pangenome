...
# get contigdbs
cp --reflink=always /stor/azolla_metagenome/Azolla_genus_metagenome/data/assembly_hybrid_doublefiltered_anvio/Azfil_wild/Azfil_wild_contigs.db		             \
...
cp --reflink=always /stor/azolla_metagenome/Azolla_genus_metagenome/data/assembly_singles_doublefiltered_anvio/Azmex_IRRI_486/Azmex_IRRI_486_contigs.db		     \
  data/MAG_anvi_dbs/Azmex_contigs.db
cp --reflink=always /stor/azolla_metagenome/Azolla_genus_metagenome/data/assembly_singles_doublefiltered_anvio/Azmic_IRRI_456/Azmic_IRRI_456_contigs.db		     \
  data/MAG_anvi_dbs/Azmic_contigs.db
cp --reflink=always /stor/azolla_metagenome/Azolla_genus_metagenome/data/assembly_singles_doublefiltered_anvio/Azspnov_IRRI1_472/Azspnov_IRRI1_472_contigs.db	 \
  data/MAG_anvi_dbs/Azcar1_contigs.db
cp --reflink=always /stor/azolla_metagenome/Azolla_genus_metagenome/data/assembly_singles_doublefiltered_anvio/Azspnov_IRRI2_489/Azspnov_IRRI2_489_contigs.db	 \
  data/MAG_anvi_dbs/Azcar2_contigs.db
cp --reflink=always /stor/azolla_metagenome/Azolla_genus_metagenome/data/assembly_singles_doublefiltered_anvio/Aznil_IRRI_479/Aznil_IRRI_479_contigs.db		     \
  data/MAG_anvi_dbs/Aznil_contigs.db
